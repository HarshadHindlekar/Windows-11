...
const ProjectCard = ({ repo }) => {
  ...
  return (
    <div className="bg-neutral-900/80 rounded-md px-4 py-3 hover:translate-x-1 hover:-translate-y-1 duration-300 text-selection">
...
const AboutMe = ({ page, handleDivClick, expandedDiv }) => {
  ...
  return (
    <main className="h-[65vh] w-full mx-2.5 my-2 overflow-y-auto">{renderPageContent()}</main>
  );
};
